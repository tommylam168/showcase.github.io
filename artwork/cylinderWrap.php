...
body{background:#000;color:rgb(236,132,57)}
...
.strip div {
	...
	width:34px;
	opacity: 1;}
.strip .a {background-position: 792px 0;
...
@-moz-keyframes spin{from{-moz-transform:rotateY(0)}to{-moz-transform:rotateY(-360deg)}}
